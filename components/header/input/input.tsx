...
const Input = () => {
    ...
    return (
            <div className='relative rounded-full bg-gray-700 opacity-90 lg:h-20 h-16 lg:w-[550px] sm:w-96 w-full'>
                ...
                <label  htmlFor="emailLabel" className={`${onTop}`}><i className='bi bi-envelope-fill'> </i>Enter Your Email Adress</label>
                <button className="absolute right-1 top-1 lg:right-1.5 lg:top-1.5 rounded-full bg-yellow-400 py-4 px-3 lg:py-5 lg:px-8 font-semibold lg:font-semibold text-black text-md lg:text-xl hover:bg-yellow-600" type="button" id="talk">Let's Talk</button>
            </div>
    )
}
